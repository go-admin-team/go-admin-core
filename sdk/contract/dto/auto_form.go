...
// designer. They have no framework dependency of their own; they exist here
// because a hand-written Service that stores a designer-produced form
// (sys_dict, sys_config, etc.) needs the same shape whether it lives in
// go-admin or in a third-party app.
